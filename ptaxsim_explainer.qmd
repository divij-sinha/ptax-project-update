...
last_assessment_year_flag <- params$last_assessment_year_flag
...
if (last_assessment_year_flag == 1) {
...
::: {.column-margin}
Your property's fair market value (as determined by the Cook County Assessor's Office) is `r label_dol_amt(market_value)`. This is used to calculate your property's taxable value, called the Equalized Assessed Value (EAV). This year, your EAV was `r label_dol_amt(eav_current)`. See [Appendix A](#appendixA) for more details about this calculation. 
:::
