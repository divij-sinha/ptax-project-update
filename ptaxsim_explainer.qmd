...
<div class="box-container">
  ...
  <div class="box"> <b>(C) Change from Exemptions</b></div>
</div>
...
A second part of your tax bill changing is due to how much __all__ residential properties pay compared to __all__ commercial properties. Commercial properties are more likely to decrease their assessment value through appeals, which shifts the tax burden more onto residential properties. The share that all residential properties paid in `r current_year` `r change_str(total_res_com_share_incident, 'past')` caused your tax bill to __`r change_str(total_res_com_share_incident, "word")`__ by `r render_name(label_dol_amt(abs(total_res_com_share_incident)),change_str(total_res_com_share_incident, "past"))`
...
A final part of your tax bill change is due to a change in your exemptions. This change in exemptions between `r prior_year` and `r current_year` caused your tax bill to __`r change_str(total_exe_incident, 'word')`__ by  __`r render_name(label_dol_amt(abs(total_exe_incident)), change_str(total_exe_incident, 'past'))`__.  
 Your exemptions changed as follows. -- 

::: {.callout-tip collapse="true" title="Change in exemptions"}
`r pin_change_table`
:::

## [How did a change in the Tax Levy affect my bill?]{style="color: #E9AA01;"}

Lastly, your tax bill may have also changed due to the change in the [**Tax Levy**]{style="color: #E9AA01;"}, or the total amount of taxes imposed by the government. The total [**Tax Levy**]{style="color: #E9AA01;"} for all tax districts for this property __`r change_str(total_levy_current-total_levy_prior, "past")`__ by __`r label_p_ltx(abs((total_levy_current-total_levy_prior)/total_levy_prior))`__ between `r current_year` and `r prior_year` which caused your tax bill to __`r change_str(total_levy_current-total_levy_prior, "word")`__ by `r render_name(label_dol_amt(abs(change_from_levy)),change_str(change_from_levy,"past"))`.
