...
<form action="/email" method="post" style="display: flex; align-items: center; flex: 0 0 auto;">
    ...
    <input type="text" id="email_term" name="email_term" placeholder= "Email address" required style="margin-right: 10px;">
...
`r if(total_exe_incident > 0) {
  paste0('::: {.callout-tip collapse="true" title="Change By Exemption"}
', pin_change_table, '
:::')} `
