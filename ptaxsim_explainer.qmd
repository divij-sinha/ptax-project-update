...
quadrant_chart = ggplot() +
 ...
 geom_ribbon(data = line_data, aes(x = x, ymin = y, ymax = max), fill = "#ff696144", alpha = 0.1) +  # Shade area above the line
  ...
  annotate("text", x = max*.98, y = max*0.05, label = "Increased Tax Burden",fontface = "bold", hjust = 1) +  # Label at the end of positive x-axis
  annotate("text", x = min*.98, y = max*0.05, label = "Decreased Tax Burden",fontface = "bold", hjust = 0) +  # Label at the end of negative x-axis
  annotate("text", x = 0, y = max*.95, label = "Increased Levy", fontface = "bold") + # Label at the top of x-axis
  annotate("text", x = 0, y = min*.95, label = "Decreased Levy", fontface = "bold") +  # Label at the top of x-axis
  annotate("text", x = max*.5, y = max*.5, label = "Tax Bill Increases") +
  annotate("text", x = min*.5, y = min*.5, label = "Tax Bill Decreases")
```
